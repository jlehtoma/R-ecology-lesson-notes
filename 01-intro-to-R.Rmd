...
```{r, echo=FALSE, eval=FALSE, purl=FALSE, message = FALSE}
source("setup.R")
```
...
### How to name your variables (objects)

+ Explicit
+ Not too long
+ Cannot start with a number
+ R is case-sensitive
+ Same names are reserved
+ Don't overwrite (shadow) existing names
+ Avoid dots (`.`) in the names, even if perfectly legal
+ Above, **be consistent**
 
In R, two popular style guides are [Hadley Wickham's](http://adv-r.had.co.nz/Style.html) and
...
> ### Challenge 1.3 NOSHOW {.challenge}
>
